% Méthode des rectangles : bord droit
% >> calculDroit(borne inférieure, borne supérieure, taille des subdivisions)
% Etape 1 : appliquer la fonction au bord droit de chaque subdivision
...
function var = calculDroit(a, b, n)                     % Départ de la fonction
    disp('Methode des rectangles - bord droit :')
    x = a+n : n : b;                                    % x = vecteur des valeurs de chaque subdivision
    ...
    for j = a : n2 : b-n2                               % pour chaque subdivision
        aire += y(i+1) * n2;                            % cumuler les aires calculées (pour N subdivisions)
